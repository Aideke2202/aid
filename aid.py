...
"""
                    ...
                    if "429" in error_msg or "RESOURCE_EXHAUSTED" in error_msg:
                        st.error("⏳ Исчерпан дневной лимит бесплатных запросов к ИИ (20 запросов в день). Пожалуйста, подождите или смените API-ключ!")
                    elif "401" in error_msg or "UNAUTHENTICATED" in error_msg:
                        st.error("❌ Ошибка авторизации: Указан недействительный API-ключ. Пожалуйста, перепроверьте его!")
                    elif "400" in error_msg or "API_KEY_INVALID" in error_msg or "expired" in error_msg.lower():
                        st.error("🔄 Срок действия этого API-ключа истек или он недействителен. Пожалуйста, сгенерируйте НОВЫЙ ключ в Google AI Studio и вставьте его слева!")
                    else:
